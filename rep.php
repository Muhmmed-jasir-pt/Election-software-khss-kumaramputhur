...
if (mysqli_num_rows($res)>0) {
  while ($images=mysqli_fetch_assoc($res)) {?>
    <div class="v1">
    <img class="i1" src="cd_images/<?=$images['photo'] ?>">
...
if (mysqli_num_rows($res)>0) {
  while ($images=mysqli_fetch_assoc($res)) {?>
<div class="v2">
  <img class="i2" src="cd_images/<?=$images['photo'] ?>">
...
if ($num>0) {
  while ($images=mysqli_fetch_assoc($res)) {?>
    <div class="v3">
      <img class="i3" src="cd_images/<?=$images['photo'] ?>">
...
if (mysqli_num_rows($res)>0) {
  while ($images=mysqli_fetch_assoc($res)) {?>
    <div class="v4">
      <img class="i4" src="cd_images/<?=$images['photo'] ?>">
